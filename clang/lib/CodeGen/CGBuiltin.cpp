...
RValue CodeGenFunction::EmitBuiltinExpr(const GlobalDecl GD, unsigned BuiltinID,
  ...
  case Builtin::BICNOT: {
    ...
    args.push_back(ControlQbit);
    Value *TargetQbit = EmitScalarExpr(E->getArg(1));
    args.push_back(TargetQbit);
    ...
    return RValue::get(Builder.CreateCall(F, llvm::makeArrayRef(args)));
  }
  case Builtin::BIX: {
  ...
  case Builtin::BIToffoli: {
    ...
    args.push_back(ControlQbit1);
    Value *ControlQbit2 = EmitScalarExpr(E->getArg(1));
    args.push_back(ControlQbit2);
  ...
  case Builtin::BIa_eq_a_plus_b: {
    ...
    return RValue::get(Builder.CreateCall(F, makeArrayRef(args)));
  }
