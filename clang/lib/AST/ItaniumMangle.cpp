...
void CXXNameMangler::mangleType(const BuiltinType *T) {
  ...
  case BuiltinType::zzBit: Out << "zz"; break; // Scaffold
  case BuiltinType::zgBit: Out << "zg"; break;  // Scaffold
  case BuiltinType::ooBit: Out << "oo"; break;  // Scaffold
  case BuiltinType::ogBit: Out << "og"; break;  // Scaffold
