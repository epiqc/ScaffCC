...
TypeWithKeyword::getKeywordForTagTypeKind(TagTypeKind Kind) {
  ...
  case TTK_Qunion: return ETK_Qunion; // Scaffold
  case TTK_Qstruct: return ETK_Qstruct; // Scaffold
  }
...
TypeWithKeyword::getTagTypeKindForKeyword(ElaboratedTypeKeyword Keyword) {
  ...
  case ETK_Qunion: return TTK_Qunion; // Scaffold
  case ETK_Qstruct: return TTK_Qstruct; // Scaffold
...
TypeWithKeyword::KeywordIsTagTypeKind(ElaboratedTypeKeyword Keyword) {
  ...
  case ETK_Union:
  case ETK_Enum:
  case ETK_Qstruct: // Scaffold
  case ETK_Qunion: // Scaffold
    return true;
  }
  llvm_unreachable("Unknown elaborated type keyword.");
}
...
StringRef TypeWithKeyword::getKeywordName(ElaboratedTypeKeyword Keyword) {
  ...
  case ETK_Qstruct: return "qstruct"; // Scaffold
  case ETK_Qunion: return "qunion"; // Scaffold
  }
