...
#include "clang/Basic/OpenCLImageTypes.def"
      ...
      PREDEF_TYPE_QBIT_ID = 136,
      /// \brief The 'cbit' type in Scaffold
      PREDEF_TYPE_CBIT_ID = 137,
      /// \brief The 'qint' type in RKQC
      PREDEF_TYPE_QINT_ID = 138,
      PREDEF_TYPE_zzBit_ID = 139,
      PREDEF_TYPE_zgBit_ID = 140,
      PREDEF_TYPE_ooBit_ID = 141,
      PREDEF_TYPE_ogBit_ID = 142,
      /// \brief the 'abit' type in Scaffold
      PREDEF_TYPE_ABIT_ID = 143
    };
