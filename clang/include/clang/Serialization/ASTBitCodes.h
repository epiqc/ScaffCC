...
namespace serialization {
    ...
    enum PredefinedTypeIDs {
      ...
      PREDEF_TYPE_QBIT_ID = 70,
      /// \brief The 'cbit' type in Scaffold
      PREDEF_TYPE_CBIT_ID = 71,

      /// \brief The 'qint' type in RKQC
      PREDEF_TYPE_QINT_ID = 72,
      PREDEF_TYPE_zzBit_ID = 73,
      PREDEF_TYPE_zgBit_ID = 74,
      PREDEF_TYPE_ooBit_ID = 75,
      PREDEF_TYPE_ogBit_ID = 76,
      /// \brief the 'abit' type in Scaffold
      PREDEF_TYPE_ABIT_ID = 77,
