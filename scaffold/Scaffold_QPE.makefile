...
CC_FLAGS=-c -cc1 -emit-llvm -I/usr/include -I/usr/include/x86_64-linux-gnu -I/usr/lib/gcc/x86_64-linux-gnu/4.6/include -DN_LOWER=$(QPE_N) -DACPA_K_VAL=$(QPE_ACPA_K)
...
#all:
#@echo "MK: FILENAME = $(FILENAME)"
#@echo "Makefile: QPE_N = $(QPE_N)"
#@echo "Makefile: QPE_ACPA = $(QPE_ACPA_K)"
...
$(FILE).ll: $(FILE)_merged.scaffold
	...
	@$(CC) -c -emit-llvm -I/usr/include -I/usr/include/x86_64-linux-gnu -I/usr/lib/gcc/x86_64-linux-gnu/4.6/include -DN_LOWER=$(QPE_N) -DACPA_K_VAL=$(QPE_ACPA_K) $(FILE)_merged.scaffold -o $(FILE).ll
